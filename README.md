...
```
sh -c "$(wget https://raw.githubusercontent.com/tromcho/OneClickCDN/9.2.0/OneClickCDN.sh -O -)"
```
...
```
sh -c "$(wget https://raw.githubusercontent.com/Har-Kuun/OneClickCDN/master/uninstall.sh -O -)"
```
